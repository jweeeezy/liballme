...
/*   Updated: 2022/12/14 17:03:01 by jwillert         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ft_printf.h"

static int	ft_check_specifier(va_list args, char c, t_vector_str *vector)
{
	if (c == 'c')
...
//		Implement new ft_atoi_long also for error handling
//		Exit or return in case of error?
