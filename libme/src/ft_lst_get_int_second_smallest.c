...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   ft_lst_get_int_second_smallest.c                   :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: jwillert <jwillert@student.42heilbronn.de> +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/11/14 13:21:19 by jwillert          #+#    #+#             */
/*   Updated: 2022/11/14 13:47:11 by jwillert         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	ft_lst_get_int_second_smallest(t_lst *lst_to_search)
{
	...
	if (lst_to_search->next == NULL)
		return (0);
	int_smallest = ft_lst_get_int_smallest(lst_to_search);
